                    ...
                    @if(session('result'))
                        <div class="bg-white p-6 md:p-8 rounded-3xl shadow-xl shadow-brandBlue/10 border border-green-100 animate-fade-in-up relative overflow-hidden">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="bg-brandBlue/5 p-4 rounded-2xl border border-brandBlue/10">
                                ...
                                <div class="bg-orange-50 p-4 rounded-2xl border border-orange-100 flex flex-col justify-center">
                                    <span class="text-brandOrange text-xs font-bold tracking-wider mb-1">{{ session('result')['evaluation'] }}</span>
                                    <p class="text-gray-700 text-xs leading-tight font-medium">"{{ session('result')['impact_analysis'] }}"</p>
                                </div>
                            </div>

                            <div class="flex flex-wrap gap-2">
                                <span class="bg-gray-50 border border-gray-100 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-xl">P: {{ session('result')['protein'] ?? 0 }}g</span>
                                <span class="bg-gray-50 border border-gray-100 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-xl">K: {{ session('result')['carbo'] ?? 0 }}g</span>
                                <span class="bg-gray-50 border border-gray-100 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-xl">L: {{ session('result')['fat'] ?? 0 }}g</span>
                            </div>
                        </div>
                    @endif
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6 animate-fade-in-up delay-100">
                    ...
                    @if(session('result'))
                        <div class="bg-white p-6 rounded-[2rem] shadow-2xl shadow-brandBlue/10 border border-green-100 animate-fade-in-up mt-4 relative overflow-hidden">
                            <div class="absolute top-0 left-0 w-2 h-full bg-green-500"></div>
                            <h4 class="text-base font-black text-brandBlue mb-4">{{ session('result')['food_name'] }}</h4>
                            
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="bg-brandBlue/5 p-3 rounded-2xl border border-brandBlue/10">
                                    <span class="text-brandBlue/60 text-[10px] font-bold uppercase tracking-wider">Kalori</span>
                                    <p class="text-2xl font-black text-brandBlue mt-1">{{ session('result')['calories'] }}</p>
                                </div>
                                <div class="bg-orange-50 p-3 rounded-2xl border border-orange-100 flex flex-col justify-center">
                                    <span class="text-brandOrange text-xs font-bold tracking-wider mb-1">{{ session('result')['evaluation'] }}</span>
                                    <p class="text-gray-700 text-[11px] leading-tight font-medium">"{{ session('result')['impact_analysis'] }}"</p>
                                </div>
                            </div>
                        </div>
                    @endif
